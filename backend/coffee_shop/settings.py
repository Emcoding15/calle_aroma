...
SECRET_KEY = "django-insecure-w%#_xz0!yh#tw!*_cjz$b$zph!^41c2twz=psz0jo!q)8njjwo"
...
DATABASES = {
    'default': {
        ...
        'NAME': 'coffee_shop_db',         # your database name
        'USER': 'coffee_user',            # your PostgreSQL username
